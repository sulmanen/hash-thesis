...
The goal of LSH is to hash data points in a way so the probability of collision is high for points close to one another compared to points that are far apart. By allowing for small error in the results and adding to storage requirements, the query time is significantly improved. \cite{Gionis1999}
