...
f-measure = F_1 = \frac{2 \times TP}{TP + FP + 1}
\end{equation}
...
Precision, Recall, F-Factor, and Accuracy are biased and should be used only if these biases are well understood. Precision nor recall tells nothing about how well the model handles negative cases. \cite{POWERS2011}
