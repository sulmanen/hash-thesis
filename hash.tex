...
The inverted file allows to rapidly access a short list of images close to the query \cite{Jegou2008}. In addition to the image index, an encoding of the difference between the query vector and the coarse centroid (table).
\def\arraystretch{1.5}
\begin{table}[htb]
