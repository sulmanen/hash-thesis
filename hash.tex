...
In \cite{Arandjelovic2013}, Arandjelovi\'{c} and Zisserman modify VLAD in three ways to improve performance. First they decrease burstiness (fig. \ref{vladburstiness}), few large components in the VLAD vector can dominate similarity computations. Intra-normalization alleviates burstiness \cite{Arandjelovic2013}.
