...
In asymmetric distance computation (ADC), the database vectors $y$ are quantized but the query is not. This achieves lower distance distortion over the quantized query case called \emph{symmetric distance computation} (SDC) not covered here.
