...
Hamming distance is the number of characters two strings differ\cite{Hamming1950}. In binary strings it is the number of bits by which two binary numbers differ.
