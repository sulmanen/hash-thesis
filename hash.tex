...
\begin{figure}[htb]
\begin{center}
\includegraphics[height=4cm]{figures/sdcadc}
\end{center}
\caption{The increased distance distortion in the symmetric case (SDC) vs. the asymmetric case (ADC) introduced by the extra quantization of $q(x)$. \cite{Jegou2014}}
\label{nosdc}
\end{figure}
