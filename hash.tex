...
\begin{table*} \footnotesize
\caption{ $Delta$ Precision $\mathcal{P}$ (eq. \ref{precision}), Recall (eq. \ref{recall}) $\mathcal{R}$ and $\mathcal{P}/\mathcal{R}$ for NDID by Simple Hash and DCT Hash vs. Local Features based on table \ref{precisionrecall}.}
...
\cmidrule{2-4} \cmidrule{6-8}
 Modification & $\Delta \mathcal{P}$ & $\Delta \mathcal{R}$ & $\Delta \mathcal{P} / \mathcal{R}$ &\phantom{abc} & $\Delta \mathcal{P}$ & $\Delta \mathcal{R}$ & $\Delta \mathcal{P} / \mathcal{R}$ \\ \midrule
 P 53\% Scale   & 0.1709 & -0.007026  & 0.1781    &\phantom{abc} & 0.8614 & 0.9976 & 0.8635\\
 T 53\% Scale   & -0.01660 & 0.02822  & -0.04621  &\phantom{abc} & 0.8234 & 0.9804 & 0.8398\\
 P 83\% Scale   & 0.1703  & -0.001757 & 0.1721    &\phantom{abc} & 0.8611 & 0.9988 & 0.8620\\
 T 83\% Scale   & 0.03379 & -0.004860 & 0.03839   &\phantom{abc} & 0.8219 & 0.9804 & 0.8468\\
 P Crop 10px    & 0.9849  & 0.07713   & 0.1298    &\phantom{abc} & 0.8560 & 0.9788 & 0.8746\\
 T Crop 10px    & 0.05873 & 0.2330    & -0.2072   &\phantom{abc} & 0.8139 & 0.9193 & 0.8853\\
 P 10\% Border  & 0.9817  & 0.9915    & -1,648    &\phantom{abc} & 0.01681& 0.03637 & 0.4597\\
 T 10\% Border  & 0.7262  & 0.9790    & -9.540    &\phantom{abc} & 0.1163 & 0.05831 & 1.994\\
 P Rotate 10\%  & 0.9849  & 0.9911    & -2.957    &\phantom{abc} & 0.0205 & 0.0107 & 1.911 \\
 T Rotate 10\%  & 0.7065  & 0.9764    & -14.57    &\phantom{abc} & 0.3708 & 0.07517 & 4.933 \\
 P Normalize    & 0.1762  & 0.0021    & 0.1592    &\phantom{abc} & 0.8585 & 0.9946 & 0.8631 \\
 T Normalize    & 0.03464 & 0.004883  & 0.0303    &\phantom{abc} & 0.8300 & 0.9976 & 0.8320 \\
 P Saturate     & 0.1846  & 0.0.0452  & 0.1463    &\phantom{abc} & 0.8612 & 1 & 0.8612\\
 T Saturate     & 0.03647 & 0.04380   & -0.004170 &\phantom{abc} & 0.8303 & 1 & 0.8303 \\
    \bottomrule
\end{tabular}
\end{center}\end{table*}
