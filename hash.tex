...
\end{equation}
and it describes the direction in which parameters should be adjusted to best fit the model. This gradient vector can then be classified using a discriminative classifier. The Fisher information matrix $F_{\lambda}$ is used for normalization required by the discriminative classifiers. \cite{Perronnin2007}
