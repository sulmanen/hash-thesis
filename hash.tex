...
\caption{ NDID by Simple Hash results for duplicate sets (table \ref{modifiedimages}) for Paintings data from \cite{Vedaldi2012}. }
\label{siftresults}
\begin{center}
...
\begin{table*}
\caption{NDID by Local Features results for duplicate sets (table \ref{modifiedimages}) for Paintings data from \cite{Vedaldi2012}. The results are for }
\label{simpleresults}
\begin{center}
