...
\cmidrule{2-3} \cmidrule{5-6}
 Local Features & DCT & Simple &\phantom{abc} & DCT & Simple\\ \midrule
  ...
  Crop 10px    & < 2.2e-16 & very small &\phantom{abc} & 4.266e-11 & < 2.2e-16\\
  10\% Border  & very small & very small & \phantom{abc} & very small & < 2.2e-16\\
  Rotate 10\%  & very small & very small &\phantom{abc} & very small& < very small\\
...
Local features performs NDID with excellent numbers in the 10\% white border and 10\% rotate cases for both the Paintings and the ThingLink datasets with $\mathcal{P} > 92\%$ and $\mathcal{R} > 99 \%$ (table \ref{informednessmarkedness}). Since the rotation and adding a white border to the image alter the relative values of the image pixels, the perceptual hashes are unable to cope ($\mathcal{R}~0$ and $\mathcal{P} < 20\%$) \ref{informednessmarkedness}.
