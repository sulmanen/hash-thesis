...
The DCT Hash operates in the frequency domain. Especially the low frequency DCT compoenents of the image are difficult to change without changing the contents of the image \cite{Fridrich1999}. The process uses a small scaled version of the image, a dct transform and thresholding to produce an $L=64$ length hash.
