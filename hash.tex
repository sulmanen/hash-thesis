...
Considering the 128 dimentional SIFT descriptor and 10 million images, if one uses 400 hash functions $f_j:\mathcal{V} \rightarrow R$, $f_j, i = 1 \ldots 400$, the similarities are evaluated on a dataset with 128 columns but only 400 rows.
