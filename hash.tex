...
Detector and descriptor that are faster to compute than state-of-the-art methods.

SURF introduces the 'Fast-Hessian' detector that relies on integral images to reduce the computation time.

The descriptor is a distribution of Haar-wavelet reponses within the interest point neighbourhood. The calculation of the descriptor also uses integral images for speed.
...
An integral image (eq. \ref{integralimage}) at point $x, y$ sums up the pixels above and below. \cite{Viola2001}
