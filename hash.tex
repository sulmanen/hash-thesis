...
min-Hash (eq. \ref{minhash}) is the probability that sets $\mathcal{A}_1$ and $\mathcal{A}_2$ have equal min-Hashes is the same as their similarity (eq. \ref{similarityminhash}) \cite{Chum2008}. The similarity function can vary. Set similarity or Jaccard similarity is demonstrated in eq. \ref{similarityminhash}
