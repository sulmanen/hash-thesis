...
The Paintings Dataset from \cite{Vedaldi2012} contains images of homogenous quality and domain. ThingLink images are very heterogenous in quality and subject. An image dataset of 446 ThingLink images excluding duplicates is used to evaluate performance in the ThingLink domain.
