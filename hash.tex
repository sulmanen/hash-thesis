...
Optimization outcome is $D'=64$ for $k=16$ and $B=128$ by which the search performs very well \cite{Jegou2014}. From 10M images a Euclidean NN search with VLAD takes 7.2s. An ADC search takes 716ms. VLAD with IVFADC takes 46ms \cite{Jegou2014}.
\clearpage
