...
$\mathcal{C}_s$ & SIFT Classifier cutoff score\\
  ...
  $s_{-P}$ & image score describing fit to database image in the TN simulation dataset\\
\end{tabular}
