...
Key-point detectors have been widely developed in the last decade. The steps for image classification with these methods are the same.

\begin{enumerate}
\item Find key-points of interest in image
\item Encode key-points in a visual descriptor
...
$D$ are key-point candidates. The robust key-points are weeded out by fitting them to the surrounding data. \cite{Lowe2004} Adding the offset
