...
Estimating the Nearest Neighbor between Fisher Vectors can be performed via dot-product \cite{Perronnin2010a}, a simple operation. For the actual implementation in \cite{Perrornnin2010a} cosine similarity (dot product of L2-normalized vectors).
