...
To improve scalability, one can relax the conditions on nearest neighbor. Approximate Nearest Neighbor assigns the nearest neighbor according to probability.
