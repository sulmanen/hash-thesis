...
Simulation code for Local Features use the SIFT-descriptor (section \ref{SIFTSection}). For retrieval an inverted file is used. Explain the descriptor and the retrieval structures used here
