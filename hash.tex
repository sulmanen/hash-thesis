...
\caption{ Precision $\mathcal{P}$ and Recall $\matcal{R}$ NDID by Local Features results for duplicate sets (table \ref{modifiedimages}) for Paintings data from \cite{Vedaldi2012}, with $\mathcal{C}_s = 19$.}
...
\cmidrule{2-4} \cmidrule{6-8} \cmidrule{10-12}
 ...
 P Rotate 10\%  & 0.01449 & 0.003659 & 3.961 &\phantom{abc} & 0.0205 & 0.0107 & 1.9107 &\phantom{abc} & 0.9994 & 0.9947 & 1.005 \\
 T Rotate 10\%  & 0.2143 & 0.01382 & 15.5 &\phantom{abc} & 0.3708 & 0.07517 & 4.9326 &\phantom{abc} & 0.9208 & 0.9903 & 0.9297 \\
