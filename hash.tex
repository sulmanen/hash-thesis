...
\cmidrule{2-4} \cmidrule{6-8} \cmidrule{10-12} \cmidrule{14-16}
    ...
    53\% Scale   & 0,9435 & 0,9452 & 0,9443 &\phantom{abc} & 0,9914 & 0,9928 & 0,9921&\phantom{abc} & 0.9000 & 0.9161 & 0.9080 &\phantom{abc} & 0.7500 & 0.9193 & 0.8303\\
    83\% Scale   & 0,9558 & 0,9567& 0,9563&\phantom{abc} & 0,9927 & 0,9941 & 0,9934 &\phantom{abc} & 0.9000& 0.9161 & 0.9080&\phantom{abc} & 0.7500 & 0.9193 & 0.8303\\
    Crop 10px    & 0,2124 & 0,5346 & 0,3370 &\phantom{abc} & 0,9053 & 0,8974 & 0,9013&\phantom{abc} & 0.8558 & 0.8654 & 0.8606 &\phantom{abc} & 0.6854 & 0.8807& 0.7769\\
    10\% Border  & -0,0006 & -0,5040 & 0,0173 & \phantom{abc} & -0,1286 & -0,4757 & 0,2473&\phantom{abc} & -0.1788& -0.2577& 0.2146 &\phantom{abc} & -0.2953 & -0.2386& 0.2655\\
    Rotate 10\%  & 0 &  $\omega$&  $\omega$ &\phantom{abc} & -0,0437 & -0,4632 & 0,1423 &\phantom{abc} & -0.1418& -0.2697 & 0.1956 &\phantom{abc} & -0.4658& -0.4056& 0.4347\\
    Normalize    & 0,5761 & 0,6947 & 0,6326 &\phantom{abc} &  0,9655& 0,9626 & 0,9641 &\phantom{abc} & 0.9024 & 0.9193& 0.9108 &\phantom{abc} & 0.7500 & 0.9193 & 0.8303\\
    Saturate     & 0,3741& 0,6018 &  0,4745 &\phantom{abc} & 0,9357 & 0,9307 & 0,9332 &\phantom{abc} & 0.8951 & 0.9098& 0.9024 &\phantom{abc} & 0.7476& 0.9099 & 0.8248\\
\bottomrule
\end{tabular}
\end{center}
\end{sidewaystable}
...
\cmidrule{2-4} \cmidrule{6-8}
 ...
 P 53\% Scale   & 0.1966  & 0.1641 & 0.1805 &\phantom{abc} & 0.1533 & 0.1332 & 0.1433\\
 T 53\% Scale   & 0.0165  & 0.0121 & 0.0143 &\phantom{abc} & 0.0952 & 0.0895 & 0.0924\\
 P 83\% Scale   & 0.2014  & 0.1686 & 0.1851 &\phantom{abc} & 0.1585 & 0.1380 & 0.1483\\
 T 83\% Scale   & 0.0303  & 0.0294 & 0.0298 &\phantom{abc} & 0.1273 & 0.1217 & 0.1245\\
 P Crop 10px    & 0.2858  & 0.2753 & 0.2806 &\phantom{abc} & 0.1810 & 0.1660 & 0.1735\\
 T Crop 10px    & 0.2644  & 0.2392 & 0.2519 &\phantom{abc} & 0.1787 & 0.1772 & 0.1779\\
 P 10\% Border  & 1.2792  & 1.5003 & 0.6215 &\phantom{abc} & 1.4437 & 1.2767& 0.6448\\
 T 10\% Border  & 0.9774  & 1.2187 & 0.7964 &\phantom{abc} & 1.1434& 1.2514& 0.6524\\
 P Rotate 10\%  & 1.2202  & 1.5240 & 0.6481 &\phantom{abc} & 1.3003& 1.4460 & 0.6222\\
 T Rotate 10\%  & 0.9524  & 1.1965 & 0.8151 &\phantom{abc} & 0.9660 & 1.0467 & 0.8339\\
 P Normalize    & 0.2261  & 0.2017 & 0.2140 &\phantom{abc} & 0.1634& 0.1442 & 0.1539\\
 T Normalize    & 0.0400  & 0.0393 & 0.0397 &\phantom{abc} & 0.1019 & 0.0917 & 0.0968\\
 P Saturate     & 0.2552  & 0.2375 & 0.2464 &\phantom{abc} & 0.1579 & 0.1370 & 0.1475\\
 T Saturate     & 0.0771  & 0.0766 & 0.0768 &\phantom{abc} & 0.0994 & 0.0888 & 0.0941 \\
    \bottomrule
\end{tabular}
\end{center}\end{table*}
...
\cmidrule{2-3} \cmidrule{5-6}
 Local Features & DCT & Simple &\phantom{abc} & DCT & Simple\\ \midrule
  53\% Scale   & < 2.2e-16 & < 2.2e-16 &\phantom{abc} & 2.497e-05 & \cellcolor{blue!25}0.1348\\
  83\% Scale   & < 2.2e-16 & < 2.2e-16 &\phantom{abc} & 4.428e-06 & \cellcolor{blue!25}0.2065\\
  ...
  Normalize    & < 2.2e-16 & < 2.2e-16 &\phantom{abc} & 6.412e-05 & < 2.2e-16\\
  Saturate     & < 2.2e-16 & < 2.2e-16 &\phantom{abc} & 4.275e-05 & < 2.2e-16\\
    \bottomrule
\end{tabular}
\end{center}\end{table*}
