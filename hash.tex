...
\end{center}
\caption{ ROC Space for $0 < \mathcal{C}_{s} \leq 19$ built from query responses of duplicate sets in table \ref{modifiedimages}.}
...
\end{center}
\caption{Simple Hash NDID ROC space. Hamming Distance used denoted at each ROC point. The ROC space points are based on averaging query results of all duplicate sets in table \ref{modifiedimages}. }
...
\end{center}
\caption{Simple Hash NDID ROC space. Hamming Distance used denoted at each ROC point. The ROC space points are based on averaging results of all duplicate sets in table \ref{modifiedimages} for the ThingLink dataset. }
