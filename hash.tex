...
Comparing the classifiers visually in ROC space and PR plots in figures \ref{53label} through \ref{saturatelabel} Local Features dominates the perceptual hashes in all figures implying superior near-duplicate detection performance for both the Paintings- and the ThingLink Datasets. However, visual comparison lacks certainty. Numerical comparison demands choosing optimal points from the ROC space for numerical comparison.
