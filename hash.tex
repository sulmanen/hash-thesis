...
Writing eq. \ref{fishervectormu} by equations \ref{fishernormdistance}, \ref{fishertotalassignment} and \ref{fishermeanassignment} we get
...
w_i^X = \frac{1}{T}\sum_{t=1}^T\gamma_t(i),
  \end{equation}
and $\mu_i^X$ mean of $X$s descriptors divided by the probability of assignment to the $i$th Gaussian
