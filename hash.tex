...
For the local features classifier, ready code and database from \cite{Vedaldi2012}. The code is modified for compatibility with Matlab 2015a. Later the cutoff score is added.
