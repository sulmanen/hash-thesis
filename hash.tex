...
What is a good Hamming Distance to use for near-duplicate image detection by perceptual hashing? Contrary to the recommendation of $D_H=10$ in \cite{Zauner2010}, we find that for both hashes it is $D_H=4$ according to table\ref{informednesscomparison}.
